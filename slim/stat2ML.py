...
# -*- coding: utf-8 -*-
"""
LEGACY: Original ML training script for DominL.

For new analyses, use the integrated training pipeline instead:
  - training/train_xgboost.py      (XGBoost training)
  - training/train_compare_models.py (13-model comparison)

This script is retained for reference and uses hardcoded paths (DIR_master, DIR_save).
"""
